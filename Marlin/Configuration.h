...
/**
 * Valeur à changer en fonction de la taille du plateau 
 * Artillery Genius Pro : X=220 Y=220 Z=250
 * Artillery X2 : X=300 Y=300 Z=400
 * #define X_BED_SIZE
 * #define Y_BED_SIZE
 * #define Z_MAX_POS
*/
...
#define STRING_CONFIG_H_AUTHOR "(MrMagounet, Genius Pro TouchMI 2.1.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Genius Pro TouchMI Marlin 2.1.2"
 ...
 */
#if ENABLED(TOUCH_MI_PROBE)
  #define NOZZLE_TO_PROBE_OFFSET { -40, -30, 0 } // support de capteur Hotends TouchMI Artillery
#else
  #define NOZZLE_TO_PROBE_OFFSET { 27.25, -12.8, -1.2 }
#endif
...
#define X_BED_SIZE 220	//Genius Pro
#define Y_BED_SIZE 220	//Genius Pro
...
#define Z_MAX_POS 250	//Genius Pro
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25 // Arrêter l'impression 25mm après detection de fin de filament
